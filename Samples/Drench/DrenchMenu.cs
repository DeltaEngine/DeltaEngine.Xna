...
namespace Drench
{
	public class DrenchMenu
	{
		...
		private static readonly Rectangle HumanVsDumbAiOption = new Rectangle(0.1f, 0.375f, 0.3f,
			0.1f);
		private static readonly Rectangle HumanVsSmartAiOption = new Rectangle(0.1f, 0.5f, 0.3f, 0.1f);
		private static readonly Rectangle TwoHumanLocalOption = new Rectangle(0.1f, 0.625f, 0.3f,
			0.1f);
		...
		private static readonly Rectangle HeightSliderOption = new Rectangle(0.5f, 0.375f, 0.3f,
			0.05f);
		private readonly FontText boardSize = new FontText(FontXml.Default, "",
			new Rectangle(0.5f, 0.425f, 0.3f, 0.1f));
